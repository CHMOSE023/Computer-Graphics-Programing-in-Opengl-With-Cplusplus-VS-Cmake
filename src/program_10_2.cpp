...
/*float globalAmbient[4] = { 0.25f, 0.25f, 0.25f, 1.0f };
float lightAmbient[4] = { 0.09f, 0.09f, 0.09f, 1.0f };
float lightDiffuse[4] = { 0.45f, 0.45f, 0.45f, 1.0f };
float lightSpecular[4] = { 0.45f, 0.45f, 0.45f, 1.0f };*/
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, " program_10_2 ", nullptr, nullptr);    
    if (!window) {
...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./shaders/vertex_shader102.glsl", "./shaders/fragment_shader102.glsl");
