...
int main() {
    ...
    std::vector<float> vertices = generateSphereVertices(radius, sectorCount, stackCount);
    std::vector<unsigned int> indices = generateSphereIndices(sectorCount, stackCount);
