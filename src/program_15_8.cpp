...
Utils util = Utils();
float cameraHeight = -1.0f, cameraPitch = 11.0f;
...
void init(GLFWwindow* window) {
	...
	renderingProgramSURFACE = util.createShaderProgram("./shaders/vertex_shader155S.glsl", "./shaders/fragment_shader155S.glsl");
	renderingProgramFLOOR = util.createShaderProgram("./shaders/vertex_shader158F.glsl", "./shaders/fragment_shader158F.glsl");
	renderingProgramCubeMap = Utils::createShaderProgram("./shaders/vertex_shader155C.glsl", "./shaders/fragment_shader155C.glsl");
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, " program_15_3 ", nullptr, nullptr);    
