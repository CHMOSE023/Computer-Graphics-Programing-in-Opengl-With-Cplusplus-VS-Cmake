...
Utils util = Utils();
float cameraHeight = 3.0f, cameraPitch = 15.0f;
...
void init(GLFWwindow* window) {
	...
	renderingProgramFLOOR = util.createShaderProgram("./shaders/vertex_shader155F.glsl", "./shaders/fragment_shader155F.glsl");
