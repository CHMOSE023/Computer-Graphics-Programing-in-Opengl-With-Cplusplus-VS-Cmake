...
void init(GLFWwindow* window) {
	renderingProgramSURFACE = util.createShaderProgram("./shaders/vertex_shader154S.glsl", "./shaders/fragment_shader154S.glsl");
	renderingProgramFLOOR = util.createShaderProgram("./shaders/vertex_shader153F.glsl", "./shaders/fragment_shader153F.glsl");
