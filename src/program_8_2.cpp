...
void init(GLFWwindow* window) {
	...
	renderingProgram2 = Utils::createShaderProgram("./shaders/vert2Shader.glsl", "./shaders/fragment_shader82.glsl");
...
void display(GLFWwindow* window, double currentTime) {
	...
	glPolygonOffset(4.0f, 8.0f);		//  shadow artifacts
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, " program_8_2 ", nullptr, nullptr);    
    if (!window) {
