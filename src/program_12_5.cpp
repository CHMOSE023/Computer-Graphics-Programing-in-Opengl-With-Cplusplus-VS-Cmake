...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, " program_12_5 ", nullptr, nullptr);    
    if (!window) {
...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./shaders/vertex_shader125.glsl", "./shaders/tessC_shader125.glsl", "./shaders/tessE_shader125.glsl", "./shaders/fragment_shader125.glsl");
