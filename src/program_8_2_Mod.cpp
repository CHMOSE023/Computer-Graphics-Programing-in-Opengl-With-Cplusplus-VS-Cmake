...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(1920, 1080, "program_8_2_Mod", NULL, NULL);
...
void init(GLFWwindow* window) {
	...
	renderingProgram2 = Utils::createShaderProgram("./shaders/vertTemp.glsl", "./shaders/fragment_shader82Mod.glsl");
