...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, " program_13_1_3 ", nullptr, nullptr);    
    if (!window) {
...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./shaders/vertex_shader131.glsl",
                            "./shaders/geometry_shader1312.glsl", "./shaders/fragment_shader1313.glsl");
...
void display(GLFWwindow* window, double currentTime) {
	...
	mMat = glm::rotate(mMat, toRadians(130.0f), glm::vec3(1.0f, 0.0f, 0.0f));
