...
void init(GLFWwindow* window) {
	renderingProgramSURFACE = util.createShaderProgram("./shaders/vertex_shader152S.glsl", "./shaders/fragment_shader152S.glsl");
	renderingProgramFLOOR = util.createShaderProgram("./shaders/vertex_shader152F.glsl", "./shaders/fragment_shader152F.glsl");
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, " program_15_2 ", nullptr, nullptr);    
