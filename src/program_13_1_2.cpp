...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, " program_13_1_2 ", nullptr, nullptr);    
    if (!window) {
...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("./shaders/vertex_shader131.glsl",
                            "./shaders/geometry_shader1312.glsl", "./shaders/fragment_shader131.glsl");
