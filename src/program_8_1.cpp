...
void setupVertices(void) {
	...
	std::cout << "Vertices: " << numTorusVertices << " Indices: " << numTorusIndices << std::endl;
	std::cout << "size of ind: " << ind.size() << std::endl;
	...
	std::cout << "Torus pValues " <<torusPvalues.size() <<std::endl; 
