...
GLuint globalAmbLoc, ambLoc, diffLoc, specLoc, posLoc, mambLoc, mdiffLoc, mspecLoc, mshiLoc , tLoc;
int width, height;
float aspect;
...
void init(GLFWwindow *window) {
    renderingProgram = Utils::createShaderProgram("./shaders/vertex_shader146.glsl", "./shaders/fragment_shader146.glsl");
    ...
    texRot = glm::rotate(glm::mat4(1.0f), toRadians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
}
